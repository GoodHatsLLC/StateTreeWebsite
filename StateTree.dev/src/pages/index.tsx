...
function HomepageHeader() {
  ...
  return (
    <header className="h-4 bg-no-repeat bg-origin-content p-2 bg-contain bg-center grid grid-rows-5 grid-flow-col gap-0 h-60 justify-center items-stretch" style={{backgroundImage: `url(${treeLogo}`}}>
